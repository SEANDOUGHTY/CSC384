...
TEST_MODELS      = True
#TEST_MODELS      = False
TEST_HEURISTICS  = True#True
TEST_PROPAGATORS = True#True
    ...
    def helper_prop(self, board, prop=prop_FC, var_ord=ord_mrv):
        ...
        for i in range(len(var_array)):
            ...
            for j in range(len(var_array)):
                val_array[i].append(var_array[i][j].cur_domain())
                #print(str(var_array[i][j].cur_domain())+ ', ', end='')
            #print('/n')
